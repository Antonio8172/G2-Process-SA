...
urlpatterns = [
    ...
    path('descargar-pdf/',                  views.GraficosPDFView.as_view(),                    name = 'descargarPDF'),
    path('pdf/',                            views.PDFview.as_view(),                            name = 'hola'),
    ...
    path('crud-usuario/',                   views.CRUDUsuarioView.as_view(),                    name = 'crudUsuario'),
    ...
    path('crud-tarea/',                     views.CRUDTareaView.as_view(),                      name = 'crudTarea'),
    ...
    path('reportar-tarea/',                 views.TareaDetailView.reportar_problema,            name = 'reportarTarea'),

        #flujo
    path('ver-flujos/',                     views.FlujoListView.as_view(),                      name = 'verFlujos'),
    path('crud-flujo/',                     views.CRUDFlujoView.as_view(),                      name = 'crudFlujo'),
